...
export default function Auth() {
  ...
  const handleGoogleLogin = async () => {
    ...
    // Note: On success, the page will redirect via OAuth flow
  };
        ...
        <Card className="w-full shadow-elevated animate-fade-in">
          ...
          <CardContent className="space-y-6">
            ...
            <p className="text-xs text-center text-muted-foreground">
              Anmelden oder Registrieren mit Ihrem Google- oder Google Workspace-Konto.
              <br />
              Name und Profilbild werden automatisch übernommen.
            </p>
